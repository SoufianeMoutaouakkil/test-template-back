    ...
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Trans App.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Trans App, accessible from{" "}
            <a
              href="https://test-back-template-smdev.onrender.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://test-back-template-smdev.onrender.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://test-back-template-smdev.onrender.com/contact"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://test-back-template-smdev.onrender.com/contact
          </a>
        </li>
      </ul>
    </div>
